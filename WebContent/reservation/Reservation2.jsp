...
<body>
   ...
   <%@ include file="/header.jsp" %>
        ...
        <h1 style=" font-size: 30px; font-weight: 500; margin-bottom: 20px;margin-left: 220px;"><em></em></h1>
        <div id="wrap">
            <div id="check2" style="width: 1200px; height: 400px; ">
                <div class="step1" style="background: white;" >
                   
                    <select name="m_id" id="selectboxMovie" style="margin-left:20px; margin-top:15px; width:80%">
                ...
                <div class="step2"  style="background: white;">
                    <select name="s_date" id="selectboxDate" style="margin-left:20px; margin-top:15px; width:80%">
                        <option value="">날짜</option>
                     </select>
                   
                </div>
                <div class="step3"  style="background: white;">
                    <select name="time" id="selectboxTime" style="margin-left:20px; margin-top:15px; width:80%">
