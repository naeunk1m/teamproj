...
public class MovieFrontController extends HttpServlet {
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response)
		...
		if (command.equals("/MovieWrite.mo")) {
			...
			forward = new ActionForward();
			forward.setPath("./admin_Movie/writeForm.jsp?write=" + request.getParameter("write"));
			forward.setRedirect(true);
		} else if (command.equals("/MovieWriteAction.mo")) {
			System.out.println(" C : /MovieWriteAction.mo 호출 ");
			...
			try {
				forward = mwAction.execute(request, response);
			...
			// MovieListAction() 객체 생성
			MovieListAction listAction = new MovieListAction();
